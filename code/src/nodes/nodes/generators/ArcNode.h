...
class ArcNode : public QtNodes::NodeDelegateModel
{
    Q_OBJECT

public:
    ArcNode();
    ~ArcNode() override = default;

    QString name() const override { return "Arc"; }
    QString caption() const override { return "Arc"; }
